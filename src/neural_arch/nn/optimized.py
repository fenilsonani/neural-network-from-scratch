...
from ..optimization.fusion import get_fusion_engine, fuse_linear_activation
from ..optimization.mixed_precision import get_mixed_precision_manager, cast_to_fp16, cast_to_fp32
...
class OptimizedLinear(Module):
    ...
    def _fused_forward(self, x: Tensor) -> Tensor:
        ...
        # Use fused operation
        output_data = fuse_linear_activation(
            x.data, self.weight.data, bias_data, self.activation
        )
