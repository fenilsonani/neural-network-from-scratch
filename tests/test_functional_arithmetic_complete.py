...
from neural_arch.core.tensor import GradientFunction, Tensor, is_grad_enabled
...
class TestArithmeticOperationsComplete:
    ...
    def test_add_with_backend_operations(self):
        ...
        mock_backend.to_numpy.side_effect = lambda x: (
    ...
    def test_mul_gradient_accumulation_with_device(self):
        ...
        try:
            ...
            expected_device_calls = [
                call for call in mock_backend.to_device.call_args_list if "cuda:1" in str(call)
            ]
    ...
    def test_matmul_gradient_with_2d_tensors(self):
        ...
        try:
            ...
            transpose_calls = [
                call for call in mock_backend.transpose.call_args_list if call[0][1] == (1, 0)
            ]
