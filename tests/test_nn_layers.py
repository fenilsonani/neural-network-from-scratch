...
from neural_arch.nn import Embedding, LayerNorm, Linear, ReLU, Softmax
...
class TestNNLayers:
    ...
    def test_sequential_operations(self):
        ...
        layers = [Linear(4, 8), ReLU(), Linear(8, 4), ReLU(), Linear(4, 1)]
        ...
        try:
            ...
            if layer.weight.grad is not None:
                np.testing.assert_array_equal(
                    layer.weight.grad.data, np.zeros_like(layer.weight.data)
                )
        except AttributeError:
