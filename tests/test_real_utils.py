...
class TestRealUtils:
    ...
    def test_math_utils(self):
        ...
        try:
            from neural_arch.utils import initialize_weights, calculate_fan_in_fan_out
            from neural_arch.nn import Linear
    ...
    def test_memory_utils(self):
        ...
        try:
            from neural_arch.utils import get_memory_usage, clear_cache
    ...
    def test_visualization_utils(self):
        ...
        try:
            from neural_arch.utils import plot_loss, plot_accuracy
    ...
    def test_config_utils(self):
        ...
        try:
            from neural_arch.utils import load_config, save_config, merge_configs
    ...
    def test_metric_utils(self):
        ...
        try:
            from neural_arch.utils import accuracy, precision, recall, f1_score
