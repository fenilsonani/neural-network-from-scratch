...
class TestNumericalAccuracy:
        ...
        for m, k, n in test_cases:
            ...
            for backend in self.backends:
                ...
                if backend.name == "mps":
                    ...
                    rtol, atol = 1e-5, 1e-7
                assert np.allclose(C_result, C_ref, rtol=rtol, atol=atol), \
    ...
    def test_complex_expression_accuracy(self):
        ...
        for backend in self.backends:
            ...
            assert np.allclose(result_np, result_ref, rtol=1e-4, atol=1e-6), \
    ...
    def test_edge_cases(self):
        ...
        for test_array in edge_cases:
            for backend in self.backends:
                ...
                assert np.array_equal(result, test_array, equal_nan=True), \
    ...
    def test_broadcasting_accuracy(self):
        ...
        for shape1, shape2 in test_cases:
            ...
            for backend in self.backends:
                ...
                assert np.allclose(add_result, add_ref, rtol=1e-5), \
                ...
                assert np.allclose(mul_result, mul_ref, rtol=1e-5), \
