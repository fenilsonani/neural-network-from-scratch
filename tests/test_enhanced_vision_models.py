...
from neural_arch.models import (
    ...
    efficientnet_b0, convnext_tiny, get_model
)
from neural_arch.models.vision.resnet import (
    ResNet, BasicBlock, Bottleneck, Conv2d, BatchNorm2d,
    SqueezeExcitation, Sequential, ResNet18, ResNet50
)
from neural_arch.models.vision.vision_transformer import (
    VisionTransformer, PatchEmbed, Attention, MLP, Block,
...
class TestResNetArchitecture:
    ...
    def test_basic_block_architecture(self):
        ...
        downsample = Sequential(
            Conv2d(in_channels, out_channels_down, 1, stride_down),
            BatchNorm2d(out_channels_down)
        )
        
        block_down = BasicBlock(
            in_channels, out_channels_down, stride_down, 
            downsample=downsample, use_se=True
        )
...
class TestVisionTransformerArchitecture:
    ...
    def test_vit_transformer_block(self):
        ...
        block = Block(
            ...
            qkv_bias=True, drop=0.1, attn_drop=0.1, drop_path=0.1,
    ...
    def test_vit_class_token_and_positional_encoding(self):
        ...
        model = VisionTransformer(
            ...
            num_classes=1000, class_token=True
        )
        ...
        model_no_cls = VisionTransformer(
            img_size=224, patch_size=16, embed_dim=768,
            num_classes=1000, class_token=False, global_pool='avg'
        )
