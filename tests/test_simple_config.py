...
import tempfile
import json
from neural_arch.config import Config, load_config, save_config, DEFAULT_CONFIG
...
class TestSimpleConfig:
    ...
    def test_config_field_access(self):
        ...
        expected_fields = [
            'debug', 'log_level', 'random_seed',
            'device', 'dtype', 'num_threads', 'memory_limit_gb',
            'batch_size', 'learning_rate', 'max_epochs', 'patience',
            'gradient_clipping', 'gradient_clip_value'
        ]
