...
class TestFunctionalUtilsComprehensive:
    ...
    def test_gradient_clipping_utils(self):
        ...
        try:
            from neural_arch.functional.utils import clip_gradient_norm, clip_gradients
            ...
            large_grads = [Tensor([[100, 200]]), Tensor([[300, 400]])]
    ...
    def test_tensor_comparison_utils(self):
        ...
        try:
            from neural_arch.functional.utils import tensor_allclose, tensor_close, tensor_equal
