...
from neural_arch.config.defaults import DEFAULT_CONFIG, DEVELOPMENT_CONFIG, PRODUCTION_CONFIG
...
class TestConfigDeviceComprehensive:
    ...
    def test_config_functions_comprehensive(self):
        ...
        test_config = {"device": "cpu", "dtype": "float32", "debug": False, "learning_rate": 0.001}
