...
class TestModelCard:
    ...
    def test_model_card_optional_fields(self):
        ...
        card = ModelCard(
            name="Minimal Model", description="A minimal test model", architecture="minimal"
        )
    ...
    def test_model_card_str_representation(self):
        ...
        card = ModelCard(name="Test Model", description="A test model", architecture="cnn")
    ...
    def test_model_card_to_dict(self):
        ...
        card = ModelCard(name="Test Model", description="A test model", architecture="test")
...
class TestWeightManagement:
    ...
    def test_download_weights_success(self, mock_download):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result_path = download_weights("test_model", "config", cache_dir=Path(temp_dir))
    ...
    def test_weights_caching(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result_path = download_weights(
                "test_model", "config", cache_dir=Path(temp_dir), force_download=False
            )
...
class TestModelUtilsIntegration:
    ...
    def test_model_card_with_real_model_info(self):
        ...
        card = ModelCard(
            ...
            architecture="ResNet",
            metrics={"top1_accuracy": 0.7616, "top5_accuracy": 0.9300, "flops": "4.1G"},
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            for format_name, weights in test_formats.items():
                ...
                for key in weights:
                    ...
                    expected = (
                        weights[key].data if isinstance(weights[key], Parameter) else weights[key]
                    )
