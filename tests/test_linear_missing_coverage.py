...
class TestLinearMissingCoverage:
    ...
    def test_all_weight_initialization_schemes(self):
        ...
        np.testing.assert_array_equal(layer_zeros.weight.data, np.zeros((in_features, out_features)))
    ...
    def test_get_weight_stats_functionality(self):
        ...
        expected_keys = {"weight_mean", "weight_std", "weight_min", "weight_max", "weight_norm",
                        "bias_mean", "bias_std", "bias_min", "bias_max", "bias_norm"}
