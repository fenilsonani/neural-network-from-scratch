...
from neural_arch.functional import (
    focal_loss, label_smoothing_cross_entropy, huber_loss, 
    kl_divergence_loss, cosine_embedding_loss, triplet_loss,
...
if __name__ == "__main__":
    ...
    imbalanced_targets = np.random.choice(range(num_classes), size=batch_size, 
