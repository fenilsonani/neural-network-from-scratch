...
from neural_arch import Adam, Tensor
...
class TestAdam:
    ...
    def test_adam_zero_grad(self):
        ...
        params = {"w": Tensor([[1.0, 2.0]], requires_grad=True)}
...
class TestOptimizerIntegration:
    ...
    def test_optimizer_convergence(self):
        ...
        params = {"x": Tensor([[0.0]], requires_grad=True)}  # Start far from minimum
...
class TestOptimizerEdgeCases:
    ...
    def test_adam_numerical_stability(self):
        ...
        params = {"w": Tensor([[1e-10]], requires_grad=True)}  # Very small value
...
def test_optimizer_parameter_sharing():
    ...
    params = {"shared1": shared_param, "shared2": shared_param}  # Same tensor reference
