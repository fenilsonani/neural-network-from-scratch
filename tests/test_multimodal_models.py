...
from neural_arch.models import align_base, clip_base, clip_large, flamingo_base, get_model
...
class TestMultimodalIntegration:
    ...
    def test_all_multimodal_models_instantiable(self):
        ...
        multimodal_models = ["clip_base", "clip_large", "align_base", "flamingo_base"]
    ...
    def test_multimodal_model_configs_through_registry(self):
        ...
        for model_name, config in models_and_configs:
            try:
                ...
                assert any(
                    keyword in str(e).lower()
                    for keyword in ["config", "not found", "not implemented"]
                )
