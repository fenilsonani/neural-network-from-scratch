...
class TestExceptionClasses:
    ...
    def test_shape_error_with_params(self):
        ...
        error = ShapeError(
            "Shape mismatch", expected_shape=(3, 4), actual_shape=(5, 6), operation="matmul"
        )
    ...
    def test_dtype_error_with_params(self):
        ...
        error = DTypeError("Type mismatch", expected_dtype="float32", actual_dtype="int32")
        assert "Type mismatch" in str(error)
        assert isinstance(error, TensorError)

    def test_device_error_with_params(self):
        """Test DeviceError with parameters."""
        error = DeviceError("Device mismatch", expected_device="cuda", actual_device="cpu")
    ...
    def test_numerical_error(self):
        """Test NumericalError."""
        error = NumericalError("NaN detected", operation="sqrt", invalid_values="[-1, -2]")
    ...
    def test_optimizer_error(self):
        ...
        error = OptimizerError(
            "Invalid learning rate", optimizer_name="Adam", parameter_name="lr", invalid_value=-0.01
        )
    ...
    def test_resource_error(self):
        """Test ResourceError."""
        error = ResourceError(
            "Out of memory", resource_type="GPU memory", requested="10GB", available="8GB"
        )
...
class TestExceptionInheritance:
    ...
    def test_model_error_hierarchy(self):
        ...
        model_errors = [LayerError("test"), ParameterError("test")]
    ...
    def test_optimization_error_hierarchy(self):
        ...
        opt_errors = [OptimizerError("test"), OptimizationError("test")]
