...
from neural_arch.config import Config, ConfigManager, load_config, save_config, DEFAULT_CONFIG, validate_config
...
class TestConfig:
    ...
    def test_config_repr_str(self):
        ...
        config_dict = {"compute": {"backend": "numpy"}, "tensor": {"grad_enabled": True}, "optimizer": {"default_lr": 0.001}}
        config = Config.from_dict(config_dict)
