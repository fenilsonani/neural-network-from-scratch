            ...
            for size in self.sizes[2:]:  # Check larger sizes
                ...
                for backend_name in backends:
                    if backend_name != "numpy":
                        ...
                        if size[0] >= 1000:
                            assert speedup > 0.8, \
                                f"{backend_name} not efficient for size {size}"
    ...
    def test_memory_transfer_overhead(self):
        ...
        for backend_name in backends:
            ...
            for shape in data_sizes:
                ...
                from_time = PerformanceBenchmark.time_operation(from_device, warmup_runs=1, test_runs=5)
        ...
        for backend_name in backends:
            ...
            for shape, axis in test_cases:
                ...
                for name, func in reductions.items():
                    ...
                    print(f"  {name} {shape} axis={axis}: {elapsed*1000:.2f}ms ({throughput:.2f} GE/s)")
...
class TestPerformanceRegression:
    ...
    def test_matmul_regression(self):
        ...
        for backend_name in backends:
            ...
            assert elapsed_ms < baseline_ms * 1.5, \
