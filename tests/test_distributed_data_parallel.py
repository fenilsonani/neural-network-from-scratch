...
from neural_arch.nn import Module, Linear
...
from neural_arch.distributed.data_parallel import (
    ...
    gather, scatter, no_sync, is_distributed_training_available,
...
class TestDataParallel:
    ...
    def test_data_parallel_multi_device_forward(self):
        ...
        with patch.object(dp_module, '_scatter_inputs') as mock_scatter, \
             patch.object(dp_module, '_gather_outputs') as mock_gather:
