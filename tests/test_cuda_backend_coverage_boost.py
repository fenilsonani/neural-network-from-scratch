            ...
            with patch("neural_arch.backends.cuda_backend.CUDA_KERNELS_AVAILABLE", True):
                with patch("neural_arch.backends.cuda_backend.cp", mock_cp):
                    with patch(
                        ...
                        with patch(
                            "neural_arch.backends.cuda_backend.cuda_fused_linear_gelu"
                        ) as mock_fused:
            ...
            with patch("neural_arch.backends.cuda_backend.CUDA_KERNELS_AVAILABLE", True):
                with patch("neural_arch.backends.cuda_backend.cp", mock_cp):
                    with patch(
                        ...
                        with patch(
                            "neural_arch.backends.cuda_backend.cuda_layernorm"
                        ) as mock_layernorm:
                            ...
                            mock_layernorm.assert_called_once_with(
                                "input", "gamma", "beta", eps=1e-5
                            )
            ...
            with patch("neural_arch.backends.cuda_backend.CUDA_KERNELS_AVAILABLE", True):
                with patch("neural_arch.backends.cuda_backend.cp", mock_cp):
                    with patch(
                        ...
                        with patch(
                            "neural_arch.backends.cuda_backend.cuda_flash_attention"
                        ) as mock_flash:
