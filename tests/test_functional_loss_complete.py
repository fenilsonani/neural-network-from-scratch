...
class TestLossFunctionsComplete:
    ...
    def test_label_smoothing_cross_entropy_edge_cases(self):
        ...
        result = label_smoothing_cross_entropy(predictions, targets, smoothing=0.1, reduction='none')
    ...
    def test_cosine_embedding_loss_gradient_edge_cases(self):
        ...
        result_no_grad = cosine_embedding_loss(input1_far, input2_far, target_dissimilar, margin=0.5)
        grad_output = np.array(1.0)
