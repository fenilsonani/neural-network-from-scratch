...
from neural_arch.nn.positional import (
    SinusoidalPositionalEncoding, RotaryPositionalEmbedding, LearnedPositionalEmbedding,
    RoPE, SinusoidalPE, LearnedPE,
    create_rope, create_sinusoidal_pe
)
...
class TestLearnedPositionalEmbedding95Coverage:
    ...
    def test_learned_pe_initialization_comprehensive(self):
        ...
        # Test with dropout
        learned_pe_dropout = LearnedPositionalEmbedding(
            max_len=500,
            d_model=256,
            dropout=0.1
        )
